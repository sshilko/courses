...
final class QuestionFactory extends ModelFactory
{
    ...
    protected function getDefaults(): array
    {
        return [
           ...
           #'askedAt' => self::faker()->boolean(80) ? new \DateTimeImmutable(sprintf('-%d days', random_int(1, 100))) : null,
            'askedAt' => new \DateTimeImmutable(sprintf('-%d days', random_int(1, 100))),
